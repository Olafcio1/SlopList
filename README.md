# 🗑️ SlopList
SlopList is a collection of lists (and userscripts for them) to change what you see.<br/>
It's to make the internet cleaner: remove the AI slop.

Currently, there's only a Modrinth list.<br/>
This may change soon.

## 📩 Installing
To install the userscripts, you have to:
